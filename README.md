...
- 🎯 Entry points to execute your program using `python -m <hercules>` or `$ hercules` with basic CLI argument parsing.
...
```py
from hercules import BaseClass
from hercules import base_function
