...
async def execute_mcp_tool(
    ...
    try:
        ...
        raise Exception(f"Failed to execute MCP tool: {e}") from e
...
async def list_mcp_tools(server_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise Exception(f"Failed to list MCP tools: {e}") from e
...
async def get_mcp_resource(server_name: str, resource_uri: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise Exception(f"Failed to get MCP resource: {e}") from e
...
async def check_mcp_server_status(server_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise Exception(f"Failed to check MCP server status: {e}") from e
...
async def get_configured_mcp_servers() -> Dict[str, Any]:
    ...
    try:
        ...
        raise Exception(f"Failed to get configured MCP servers: {e}") from e