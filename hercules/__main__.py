...
from hercules.core.runner import SingleCommandInputRunner
from hercules.telemetry import EventData, EventType, add_event
from hercules.utils.gherkin_helper import process_feature_file, serialize_feature_file
from hercules.utils.junit_helper import JUnitXMLGenerator, build_junit_xml
...
def sequential_process() -> None:
    ...
    for feat in list_of_feats:
        ...
        result_of_tests.append(build_junit_xml(runner_result, execution_time, cost_metrics, feature_name, scenario))
